...
int main(int argc, char** argv) {
    _cdocs_fn_struct functions[] = {
        _cdocs_fn(
            _cdocs_fn_f(_cdocs_fn_f, "`_cdocs_fn_f_struct` initializer; function description."),
        ...
        _cdocs_fn(
            _cdocs_fn_f(_cdocs_fn_r, "`_cdocs_fn_r_struct` initializer; return description."),
        ...
        _cdocs_fn(
            _cdocs_fn_f(_cdocs_fn_p, "`_cdocs_fn_p_struct` initializer; parameter description."),
